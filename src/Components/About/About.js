    ...
    <div>
      ...
      <section className="about-me-section">
        <pre className="about-container">
          ...
          gave me to continue learning new technologies.  For example, in my projects section 
          you'll see Zen in Ten which was a group that was given a week to research and implement 
